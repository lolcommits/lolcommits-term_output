...
[Fork](https://guides.github.com/activities/forking) then clone the repository:
    ...
    git clone git@github.com:your-username/lolcommits-term_output.git
...
Request](https://github.com/lolcommits/lolcommits-term_output/compare):
...
* If you are fixing an
  [issue](https://github.com/lolcommits/lolcommits-term_output/issues), link to
